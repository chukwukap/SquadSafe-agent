...
// Validate and load required environment variables securely
const {
  WALLET_KEY,
  ENCRYPTION_KEY,
  XMTP_ENV,
...
// In-memory stores for agent and memory instances
...
/**
 * Ensure local storage directories exist for wallet and XMTP data.
 */
...
/**
 * Save wallet data to secure local storage.
 * @param userId - Unique user identifier
 * @param walletData - Wallet data as stringified JSON
 */
...
/**
 * Retrieve wallet data from secure local storage.
 * @param userId - Unique user identifier
 * @returns Wallet data as string, or null if not found
 */
...
/**
 * Initialize the XMTP client with secure key management.
 ...
 *
 * Exported for use in the main entry point (index.ts).
 */
